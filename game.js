...
function premiumChoiceShare(structs, s, state){
  ...
  function U(x){
    ...
    return (
      ...
      const ref = 180; // riferimento “premium” (puoi metterlo = target o = P.avgSpend*1.3)
const pr = (x.prezzo || 0) / ref;
- (BETA_PRICE * Math.log(pr))   // log penalizza forte gli eccessi, ma non ammazza +10€
    );
  }

  // softmax con outside option
